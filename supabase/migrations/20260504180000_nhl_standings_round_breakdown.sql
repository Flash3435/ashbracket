...
COMMENT ON FUNCTION public.fetch_nhl_edition_standings(uuid) IS
  'NHL edition leaderboard: per-round points (R1/R2/CF/SCF), bonus placeholder, overall and Round 2+ ranks. Weights R1=1,R2=2,CF=4,SCF=8.';
