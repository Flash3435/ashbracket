    ...
    >
      <div className="min-w-0">
        <p className="text-[11px] font-semibold uppercase tracking-wide text-ash-muted">
          Option A — provider fetch
        </p>
        <h2 className="mt-1 text-lg font-bold text-ash-text">Fetch latest scores</h2>
        <p className="mt-2 text-sm leading-relaxed text-ash-muted">
          Download final scores from the configured provider, preview changes, then apply
          scores and update standings.
        </p>
      </div>
      <Link
