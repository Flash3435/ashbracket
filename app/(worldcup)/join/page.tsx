      ...
      <PageTitle
        ...
        description={
          inviteMode
            ...
            : `Enter your join code, sign in, then choose your leaderboard name and join. Share links: /join/your-code or /join?code=… (sample demo code: ${SAMPLE_POOL_JOIN_CODE}).`
        }
      />
      <JoinPoolForm
        initialCode={code}
